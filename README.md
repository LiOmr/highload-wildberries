...
- cdn.wb-engineering.ru: Сеть доставки контента (CDN), которая обслуживает статические ресурсы, такие как изображения и CSS-файлы.

Отдача медиаконтента
- media.wildberries.ru: Хранение и отдача медиафайлов, включая изображения и видео.

Внешние зависимости
- rvb.ru: Внешняя зависимость для некоторых сервисов, связанных с логистикой и управлением.
