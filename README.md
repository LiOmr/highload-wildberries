...
1. **Москва и СПб**:
   - Обрабатывают 65% трафика. Требуют высокопроизводительных серверов и резервных каналов связи (≥100 Гбит/с).
   - Хранят основные базы данных (история заказов, каталог товаров).

2. **Екатеринбург и Новосибирск**:
   - Фокус на снижение задержек для Урала и Сибири. Используют реплики данных из центральных узлов.
   - Обрабатывают 25% запросов, резервируют мощности на случай сбоев в европейской части.

3. **CDN для изображений**:
   - 38 ТБ изображений распределены между всеми дата-центрами. Это снижает нагрузку на основные узлы на 30–40%.
