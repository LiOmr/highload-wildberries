...
![image](https://github.com/user-attachments/assets/cc6b6455-a1d0-4250-b78b-8b1f56f791fd)


Ниже сводная таблица для **пиковых** значений RPS:

| Датацентр           | RPS   | Объём данных (МБ/с)                   | CPU, мс/с (RPS × 150 мс)        | Примерные ядра CPU* |
|---------------------|-------|---------------------------------------|-------------------------------|----------------------|
| **Москва**          | 4 500 | 4 500 × 1 КБ ≈ **4,39 МБ/с**           | 4 500 × 150 мс = 675 000 мс/с   | ~675                |
| **Санкт-Петербург** | 2 000 | 2 000 × 1 КБ ≈ **1,95 МБ/с**           | 2 000 × 150 мс = 300 000 мс/с   | ~300                |
| **Екатеринбург**    | 1 500 | 1 500 × 1 КБ ≈ **1,46 МБ/с**           | 1 500 × 150 мс = 225 000 мс/с   | ~225                |
| **Новосибирск**     | 1 000 | 1 000 × 1 КБ ≈ **0,98 МБ/с**           | 1 000 × 150 мс = 150 000 мс/с   | ~150                |
| **Прочие**          | 1 000 | 1 000 × 1 КБ ≈ **0,98 МБ/с**           | 1 000 × 150 мс = 150 000 мс/с   | ~150                |
| **Итого**           | 10 000| ≈ **9,76–10 МБ/с**                    | 1 500 000 мс/с                | ~1 500              |
