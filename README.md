...
- **Общее число просмотров в сутки**:
  \[
    ...
    = 14\,000\,000 \times 12 
    = 168\,000\,000\ (\text{просмотров в сутки})\\)
  \]
  Это даёт ключевое понимание основных действий — просмотра каталога, карточек товаров.
...
Таким образом, **~50–100 КБ** достаточно для описания одного активного пользователя (вместе со всей историей). При 76,7 млн MAU [\[3\]](https://cmp.wildberries.ru/cmpf/Special%20project%20kit%20WB.pdf) общий объём может достигать нескольких терабайт, что не критично при грамотном распределённом хранении.
...
**Пояснения и формулы**:
- **DAU** взято из [\[4\]](https://www.retail.ru/news/oborot-wildberries-vyros-na-101-v-iii-kvartale-15-oktyabrya-2021-210183/).
...
Примерная сводка по ключевым действиям MVP и суммарным объёмам трафика:
...
1. **Просмотры**:
Исправленный вариант формулы в виде пояснения на русском:
...
- **86 400** — количество секунд в день.

Если в сутки совершается **168 млн просмотров страниц**, то:  
168 000 000 / 86 400 ≈ **1 945 RPS**.  


- **Пиковое значение**: обычно берётся коэффициент 2–3 (или выше в сезон распродаж).
