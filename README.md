...
Обоснование:
1) Географическая оптимизация задержек: Для e-commerce (особенно при просмотре каталога и поиске) это критично: задержки >100 мс снижают конверсию на 5–10% [10]
