...
**Источники данных.** В Wildberries собираются обширные данные о действиях пользователей: поисковые запросы, просмотры товаров, клики, добавление в корзину, покупки, оценки и отзывы. Эти события фиксируются в логах и хранилищах данных. Кроме поведенческих данных, учитываются свойства самих товаров – категория, бренд, описание, цена и т.д. – а также демографические данные пользователя (пол, возраст) ([Как работает система рекомендаций на Wildberries? - Библиотека Нейро](https://ya.ru/neurum/c/drugoe/q/kak_rabotaet_sistema_rekomendaciy_na_wildberries_60701f71#:~:text=%D0%95%D1%89%D1%91%20%D0%BE%D0%B4%D0%B8%D0%BD%20%D0%B2%D0%B8%D0%B4%20%D1%80%D0%B5%D0%BA%D0%BE%D0%BC%D0%B5%D0%BD%D0%B4%D0%B0%D1%86%D0%B8%D0%B9%20%E2%80%94,2)). Например, системе известно, что пользователь-женщина 25 лет часто ищет косметику, просматривал определенные бренды, и эти данные станут основой его профиля интересов.
...
**Пример реализации.** *Допустим, пользователь недавно искал и покупал товары для новорожденных.* Алгоритм обнаружит этот паттерн и будет рекомендовать ему, скажем, **детские игрушки, одежду для младенцев, подгузники** и пр. – даже если пользователь еще не просматривал конкретные товары из этих подкатегорий. Если другой пользователь часто просматривает электронику определенной марки, в его ленте появятся новинки этой марки или аксессуары к уже купленным устройствам. На странице конкретного товара (например, смартфона) под карточкой автоматически показывается список «Покупают с этим товаром» – там алгоритм подбирает **сопутствующие товары** (чехлы, наушники), основываясь на частых совместных покупках. Если продавец не настроил собственные рекомендации, система сама заполнит этот блок товарами конкурентов, релевантными текущему ([Как работает система рекомендаций на Wildberries? - Библиотека Нейро](https://ya.ru/neurum/c/drugoe/q/kak_rabotaet_sistema_rekomendaciy_na_wildberries_60701f71#:~:text=%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0%20%D1%80%D0%B5%D0%BA%D0%BE%D0%BC%D0%B5%D0%BD%D0%B4%D0%B0%D1%86%D0%B8%D0%B9%20%D0%BD%D0%B0%20Wildberries%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%D0%B5%D1%82,2)).

**Обоснование выбора подхода.** Wildberries имеет огромный каталог и аудиторию, поэтому ставка делается на масштабируемые алгоритмы машинного обучения. Классические коллаборативные фильтры и градиентный бустинг успешно работают на первых этапах, давая хорошую базу рекомендаций. Однако, чтобы учитывать сложные взаимосвязи (например, последовательность покупок, социальные тренды), компания экспериментирует с **нейросетевыми подходами**. В статье на Хабре от команды Wildberries отмечено, что графовые модели (LightGCN) были внедрены как часть пайплайна рекомендаций для улучшения разнообразия подборок ([Графовые сети в рекомендательных системах / Хабр](https://habr.com/ru/companies/wildberries/articles/826422/#:~:text=%D0%AD%D1%82%D0%BE%20%D0%B1%D1%8B%D0%BB%20%D0%BC%D0%BE%D0%B9%20%D0%BF%D0%B5%D1%80%D0%B2%D1%8B%D0%B9%20%D0%BE%D0%BF%D1%8B%D1%82,%D0%BA%D0%B0%D0%BD%D0%B4%D0%B8%D0%B4%D0%B0%D1%82%D0%BD%D0%BE%D0%B9%20%D0%BC%D0%BE%D0%B4%D0%B5%D0%BB%D0%B8%20%D0%B4%D0%BB%D1%8F%20%D1%83%D0%B2%D0%B5%D0%BB%D0%B8%D1%87%D0%B5%D0%BD%D0%B8%D1%8F%20exploration)). Выбор таких моделей обусловлен их способностью учитывать структуру взаимоотношений «пользователи–товары» более полно, чем простые метрики сходства. Каждое улучшение проходит проверку: в Wildberries есть своя платформа A/B-тестирования, позволяющая на части аудитории тестировать новую модель рекомендации и объективно измерять рост метрик ([В каких командах и проектах Wildberries есть задачи для аналитиков / Хабр](https://habr.com/ru/companies/wildberries/articles/886064/#:~:text=match%20at%20L114%20%D1%80%D0%B5%D0%B7%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%82%D0%B0%D0%BC%20%D0%BF%D1%80%D0%B8%D0%BD%D0%B8%D0%BC%D0%B0%D1%82%D1%8C,%D0%BC%D0%B5%D1%82%D1%80%D0%B8%D0%BA%D0%B8%20%D0%B8%20%D1%81%D1%82%D0%B0%D1%82%D0%B8%D1%81%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D1%83%D1%8E%20%D0%B7%D0%BD%D0%B0%D1%87%D0%B8%D0%BC%D0%BE%D1%81%D1%82%D1%8C%20%D0%B8%D0%B7%D0%BC%D0%B5%D0%BD%D0%B5%D0%BD%D0%B8%D0%B9)). Таким образом, подход к рекомендациям – комбинация проверенных временем алгоритмов (для стабильной персонализации) и современных ML-решений (для развития качества), обоснованный экспериментальными доказательствами их эффективности.
...
2. **Поиск кандидатов по тексту:** на основе обработанного запроса система извлекает из поискового индекса товары, связанные по смыслу. Важно, что совпадение может быть не прямым – алгоритм использует семантический анализ. Например, товар может не содержать конкретное слово из запроса, но система все равно выдаст его, если по совокупности характеристик и поведению пользователей он соответствует спросу ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=,%D0%B2%D1%8B%D0%B4%D0%B0%D1%87%D0%B8%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D0%B0%20%D0%B2%20%D0%BF%D0%BE%D0%BB%D0%B5%20%C2%AB%D0%B1%D1%80%D0%B5%D0%BD%D0%B4%C2%BB)). По сути, на этом этапе работает механизм сопоставления слов запроса с информацией в карточке товара (возможно, с учетом TF-IDF/BM25 весов, синонимов, морфологии). Результатом этапа является множество товаров-кандидатов, удовлетворяющих запросу по базовой текстовой релевантности.
...
4. **Многофакторное ранжирование:** для отфильтрованных кандидатов рассчитывается итоговый **скор (оценка релевантности)** с учетом множества факторов. Этот процесс – сердце поискового алгоритма Wildberries. По официальным данным, используется *сотни факторов* и машинное обучение для их агрегации ([WBTECH - Wildberries](https://wbtech.wildberries.ru/#:~:text=WBTECH%20,%D0%BD%D0%B0%D0%B9%D1%82%D0%B8%20%D0%BA%D1%80%D0%B0%D1%82%D1%87%D0%B0%D0%B9%D1%88%D0%B8%D0%B9%20%D0%BF%D1%83%D1%82%D1%8C%20%D0%BA)). В упрощенном виде Wildberries раскрыл ключевые группы факторов и их примерную важность:
...
**Пример работы поиска.** *Например, покупатель из Екатеринбурга ищет «смартфон Samsung Galaxy».* В поиске Wildberries сперва будут найдены все смартфоны Samsung Galaxy (по названию и характеристикам). Затем они будут ранжированы: выше окажется модель, которая есть на складе в Екатеринбурге или поблизости (быстрая доставка за 1–2 дня) и которая хорошо продается. Если у какой-то модели высокий рейтинг и много свежих покупок – она получит бонус. Если продавец этой модели участвует в акции со скидкой 15%, товар поднимется еще выше (акция дает дополнительный вес релевантности) ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=%D0%A3%D1%87%D0%B0%D1%81%D1%82%D0%B8%D0%B5%20%D0%B2%20%D0%BF%D1%80%D0%BE%D0%BC%D0%BE%2C%20%D1%81%D0%BA%D0%B8%D0%B4%D0%BA%D0%B8)). Допустим, один из продавцов даже запустил рекламу (Бустер) и поставил высокую ставку CPM – его товар может появиться на самой вершине, но *только* если это действительно Samsung Galaxy, иначе реклама не поможет (нерелевантные товары с рекламой не покажутся) ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=,relevance)). В итоге пользователь увидит в топ-результатах несколько подходящих смартфонов. Если он кликнет на первый же – это подтверждает, что алгоритм верно угадал его намерение. Если нет – возможно, скорректирует запрос. Но благодаря множеству факторов Wildberries стремится сразу дать вариант с оптимальным соотношением: нужный товар + от надежного продавца + по хорошей цене + с быстрой доставкой ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=%D0%A0%D0%B0%D1%81%D1%81%D1%82%D0%BE%D1%8F%D0%BD%D0%B8%D0%B5%20%D0%B4%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%BA%D0%B8%2C%20%D0%B2%D1%80%D0%B5%D0%BC%D1%8F%20%D1%81%D0%B1%D0%BE%D1%80%D0%BA%D0%B8%20%D0%B8,%D0%B4%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%BA%D0%B8%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0)) ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=%D0%92%20%D1%80%D0%B5%D0%B7%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%82%D0%B5%20%D1%80%D0%B0%D1%81%D1%81%D0%BC%D0%BE%D1%82%D1%80%D0%B5%D0%BD%D0%B8%D1%8F%20%D0%B2%D1%81%D0%B5%D1%85%20%D1%84%D0%B0%D0%BA%D1%82%D0%BE%D1%80%D0%BE%D0%B2,%D0%BA%D0%B0%D0%BD%D0%B4%D0%B8%D0%B4%D0%B0%D1%82%D0%B0%20%D0%BD%D0%B0%20%D0%BC%D0%B5%D1%81%D1%82%D0%B0%20%D0%B2%20%D0%B2%D1%8B%D0%B4%D0%B0%D1%87%D0%B5)).

**Обоснование подхода.** Wildberries – маркетплейс, где на один запрос могут быть тысячи товаров. Простая сортировка только по совпадению слов давно не удовлетворяет ни бизнес, ни пользователей. Поэтому применена комплексная формула ранжирования, сочетающая *релевантность по запросу* и *важные бизнес-факторы*. Такой подход мотивирован потребностями: **покупатель** хочет видеть качественные товары с быстрым получением, **продавец** хочет честной конкуренции и возможности продвинуться, **площадка** – максимизации продаж при удовлетворенности клиентов. Использование ML-моделей позволяет учесть сотни сигналов сразу и находить нелинейные зависимости. Например, модель ранжирования может быть реализована градиентным бустингом или нейронной сетью, обученной на данных кликов и покупок, чтобы предсказывать вероятность покупки для комбинации [запрос, товар]. Команда Wildberries постоянно совершенствует алгоритм: в рамках конференции WBDay сообщалось, что поиск компании работает под нагрузкой миллионов запросов с учетом сотен факторов и машинного обучения ([WBTECH - Wildberries](https://wbtech.wildberries.ru/#:~:text=WBTECH%20,%D0%BD%D0%B0%D0%B9%D1%82%D0%B8%20%D0%BA%D1%80%D0%B0%D1%82%D1%87%D0%B0%D0%B9%D1%88%D0%B8%D0%B9%20%D0%BF%D1%83%D1%82%D1%8C%20%D0%BA)). Периодически вводятся новые факторы (так, в 2023 году введен аукционный фактор рекламы). Каждое изменение – это балансировка интересов сторон. На аналитической платформе SellerMoon подчеркивается, что Wildberries не раскрывает все детали формул, но основные группы факторов и их ориентировочный вклад известны, что мы и перечислили ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=%D0%A3%D1%87%D0%B0%D1%81%D1%82%D0%B8%D0%B5%20%D0%B2%20%D0%BF%D1%80%D0%BE%D0%BC%D0%BE%2C%20%D1%81%D0%BA%D0%B8%D0%B4%D0%BA%D0%B8)) ([
        Выдача и ранжирование товаров на Wildberries в 2024 году
      ](https://sellermoon.ru/faq/wildberries/poiskovaya-sistema-wb#:~:text=%D0%A0%D0%B5%D0%B9%D1%82%D0%B8%D0%BD%D0%B3%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D0%B0%20%D0%B8%20%D0%BE%D1%82%D0%B7%D1%8B%D0%B2%D1%8B)). Выбор именно такой многофакторной модели оправдан: она обеспечивает более **качественную и персонализированную выдачу** товаров, чем простой поиск, что напрямую влияет на увеличение продаж и лояльности аудитории.
...
**Пример использования.** *Представим, продавец выставил новый пылесос по цене 10 000 ₽.* Алгоритм видит, что у конкурентов аналогичные модели продаются по 9500 ₽. Кроме того, товар пока не имеет продаж. Чтобы **попасть в поле зрения покупателей**, репрайсер может снизить цену до 9 400 ₽ (на 1% ниже конкурентов) – это повысит кликабельность примерно на 37% по данным аналитики WB ([How to Start Selling on Wildberries in Russia: Registration, Taxes & Growth Hacks](https://valen-legal.com/news/open-a-company-in-russia-to-sell-on-wildberries/#:~:text=%2A%20Price%2010,New%20Year%20discounts%20on%20electronics)). Действительно, более низкая цена привлечет внимание, товар получит первые продажи и отзывы. После набора достаточного спроса, алгоритм может постепенно повысить цену ближе к 10 000 ₽, чтобы увеличить маржу, но осторожно, чтобы не потерять позиции. Если приближается крупная акция (например, ко Дню холостяка 11.11), алгоритм за неделю до акции может поднять цену обратно до 10 500 ₽, а на дни акции дать скидку 15% (цена ~8 900 ₽) – товар получит значок “Суперскидка” и появится в разделе распродажи, компенсировав снижение цены огромным ростом объема продаж. По окончании акции цена вернется к оптимальному уровню. Таким образом, за счет **динамического изменения цены** продавец и платформа максимизируют продажи: дешевле – больше купили, дороже – больше заработали. 

**Обоснование подхода.** Wildberries – высококонкурентная платформа, где цены меняются ежедневно. Статическая цена может привести к тому, что товар выпадет из гонки: конкуренты подвинут его скидками и он перестанет продаваться. Поэтому **динамическое ценообразование** стало практически необходимостью. Оно основано на алгоритмах, которые анализируют множество факторов и автоматически корректируют цены ([Ценообразование на маркетплейсах: стратегии и вызовы](https://ecomcom.io/pricing_on_marketplaces/#:~:text=%E2%80%94%20%D0%94%D0%B8%D0%BD%D0%B0%D0%BC%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%BE%D0%B5%20%D1%86%D0%B5%D0%BD%D0%BE%D0%BE%D0%B1%D1%80%D0%B0%D0%B7%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5)). Выбор в пользу алгоритмов (вместо ручного управления ценами) обусловлен скоростью и масштабом: у крупных селлеров сотни SKU, отслеживать рынок вручную невозможно, а изменения на рынке происходят мгновенно. Автоматизация через такие инструменты, как Competera, показала значительные результаты – в одном из кейсов интеграция системы real-time pricing привела к росту продаж на 89% за квартал ([How to Start Selling on Wildberries in Russia: Registration, Taxes & Growth Hacks](https://valen-legal.com/news/open-a-company-in-russia-to-sell-on-wildberries/#:~:text=Solution%3A%20Partnering%20with%20Valen)). Алгоритмические стратегии ценообразования позволяют внедрять и сложные тактики: например, **персонализированные скидки** для удержания клиента (купоны лояльности, промокоды для брошенных корзин) – все это тоже решается на базе данных и алгоритмов, встроенных в CRM Wildberries ([How to Start Selling on Wildberries in Russia: Registration, Taxes & Growth Hacks](https://valen-legal.com/news/open-a-company-in-russia-to-sell-on-wildberries/#:~:text=Russian%20consumers%20exhibit%20fierce%20brand,time%20buyers%20into%20repeat%20customers)). Таким образом, динамическое ценообразование – оптимальный подход для маркетплейса: алгоритмы быстрее реагируют на изменения спроса и конкуренции, поддерживая баланс между привлекательностью цены для покупателя и прибылью для продавца.
...
**Пример алгоритма в действии.** *Допустим, клиент из Казани заказал товар, который находится на складе в Подмосковье.* Система сразу предсказывает: доставка займет ~2 дня (обычно фура Москва–Казань идет ночной рейс, плюс локальная доставка до пункта в Казани). Покупателю показывается срок «получение через 2 дня». Далее алгоритм планирует маршрут: товар будет отправлен ближайшим вечерним рейсом фуры до Казани. Если места в прямой машине Москва–Казань нет, алгоритм может решить отправить до Нижнего Новгорода, а там перегрузить на другой транспорт до Казани – так иногда эффективнее по загрузке. Все эти решения принимает программа, исходя из заложенных данных о рейсах и загрузке. В итоге товар приезжает в Казань вовремя. Параллельно, другой модуль рекомендательной системы заметил, что товар данного продавца стал часто заказывать Татарстан – и предложил продавцу завести часть партии сразу на Казанский склад. Продавец последовал рекомендации, завез товар ближе к спросу. Теперь будущие заказы из Казани будут доставляться *за 1 день*, что улучшит пользовательский опыт и снизит издержки на транспорт. Этот пример иллюстрирует, как взаимодействуют **прогноз спроса** и **маршрутизация**: первая заранее позиционирует товар, вторая – оптимально доставляет конкретный заказ. 

**Обоснование подхода.** Логистика – это гигантская статья расходов и одновременно фактор удовлетворенности клиентов. Wildberries инвестирует в умные алгоритмы логистики, чтобы достичь двух целей: **минимум затрат, максимум скорости**. Традиционные задачи маршрутизации – NP-трудные (коммивояжер и его обобщения), но на практике хорошие решения находятся через эвристики и ML-ассистенты. Выбор подходов обусловлен масштабом: вручную планировать пути для тысяч машин невозможно, требуется автоматизация. Алгоритмы могут быстро просчитывать миллионы комбинаций, чего человек сделать не в состоянии. Внутри команды логистики аналитики формализуют метрики, которые можно оптимизировать ML-моделями ([В каких командах и проектах Wildberries есть задачи для аналитиков / Хабр](https://habr.com/ru/companies/wildberries/articles/886064/#:~:text=%D1%87%D0%B5%D0%BB%D0%BE%D0%B2%D0%B5%D0%BA%20%D1%81%D0%B4%D0%B5%D0%BB%D0%B0%D0%BB%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%2C%20%D0%BF%D0%B5%D1%80%D0%B5%D0%B4%20%D0%BD%D0%B0%D0%BC%D0%B8,%D0%B0%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC%D0%BE%D0%B2)). Например, срок доставки превратили в числовую цель, вероятность отказа – тоже. Затем настроили модели прогнозирования и оптимизации, достигающие этих целей. В статье руководства WB отмечалось, что оптимизация логистики начинается *еще до заказа*: правильное размещение товаров существенно экономит время и деньги ([В каких командах и проектах Wildberries есть задачи для аналитиков / Хабр](https://habr.com/ru/companies/wildberries/articles/886064/#:~:text=%D0%90%20%D0%BD%D0%B0%20%D1%81%D0%B0%D0%BC%D0%BE%D0%BC%20%D0%B4%D0%B5%D0%BB%D0%B5%2C%20%D0%BE%D0%BF%D1%82%D0%B8%D0%BC%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F,%D0%AD%D1%82%D0%BE%20%D0%BF%D0%BE%D0%BB%D0%B5%D0%B7%D0%BD%D0%BE)). Этот **проактивный подход** – сильная сторона Wildberries, отличающая её от многих конкурентов. Кроме того, автоматизация логистики дала компании возможность масштабироваться: открывать сотни новых ПВЗ и быстро интегрировать курьерские службы. В итоге алгоритмы логистики Wildberries – комплекс прогнозных моделей и оптимизационных алгоритмов, оправданный экономически (снижение затрат на км пути, на хранение, на возвраты) и необходимый для поддержки репутации быстрой доставки.
...
- *Демографические данные пользователя:* пол, возраст, местоположение. Эти данные помогают агрегировать предпочтения. Например, женщины чаще покупают платья, мужчины – электронику, молодежь – модные гаджеты, и т.д. Зная профиль, можно отфильтровать несоответствующие товары (мужчине – не показывать косметику для женщин и наоборот) ([Как работает система рекомендаций на Wildberries? - Библиотека Нейро](https://ya.ru/neurum/c/drugoe/q/kak_rabotaet_sistema_rekomendaciy_na_wildberries_60701f71#:~:text=%D0%95%D1%89%D1%91%20%D0%BE%D0%B4%D0%B8%D0%BD%20%D0%B2%D0%B8%D0%B4%20%D1%80%D0%B5%D0%BA%D0%BE%D0%BC%D0%B5%D0%BD%D0%B4%D0%B0%D1%86%D0%B8%D0%B9%20%E2%80%94,2)).
...
**Этапы работы алгоритма.**
1. **Сегментация пользователя:** на основе собранных данных пользователь может быть отнесен к определенным сегментам или кластерам. Например, алгоритм может определить, что пользователь A – «молодая мама, интересуется детскими товарами и бюджетной одеждой», а пользователь B – «мужчина-геймер, интересуется электроникой премиум-класса». Эта сегментация может выполняться алгоритмами кластеризации или правил. Также может быть продолжением профиля рекомендаций (см. персональные рекомендации выше). В Wildberries появление персонализации заметили, когда разные пользователи стали получать разный порядок товаров, основанный на их поведении (что искал ранее, что смотрел, что покупал) ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D1%8C%20%D1%81%D0%B5%D0%B3%D0%BE%D0%B4%D0%BD%D1%8F%D1%88%D0%BD%D0%B5%D0%B3%D0%BE%20%D0%B4%D0%BD%D1%8F%3A%20%D0%B7%D0%B0%D0%BC%D0%B5%D1%87%D0%B5%D0%BD%D1%8B%20%D0%BF%D0%B5%D1%80%D0%B2%D1%8B%D0%B5,%D0%BF%D0%B5%D1%80%D1%81%D0%BE%D0%BD%D0%B0%D0%BB%D0%B8%D0%B7%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%BD%D0%BE%D0%B9%20%D0%B2%D1%8B%D0%B4%D0%B0%D1%87%D0%B8%20%D0%B2%20%D0%B0%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC%D0%B0%D1%85%20Wildberries)).
2. **Адаптация ранжирования под пользователя:** когда пользователь заходит, скажем, в категорию «кроссовки», система формирует базовый список товаров (как если бы без персонализации – по общей популярности). Далее алгоритм перестраивает порядок с учетом предпочтений пользователя. Например, если пользователь прежде чаще покупал бренд Adidas, то в разделе «кроссовки» для него модели Adidas будут подняты выше, чем для другого пользователя, у которого в приоритете Nike. Если это поиск, то персонализатор может повысить в ранге товары той категории, которой пользователь интересуется. По сути, персонализация – это дополнительный *коэффициент релевантности*, зависящий от пользователя. Он умножается на исходный скор товара. В результате выдача “поворачивается” в сторону интересов конкретного человека. Wildberries тестирует такую систему: например, начало учитывать **ранее просмотренные карточки, покупки конкретного пользователя** при сортировке результатов ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%AD%D1%82%D0%BE%20%D0%BF%D0%BE%D1%81%D1%82%D1%80%D0%BE%D0%B5%D0%BD%D0%B8%D0%B5%20%D1%80%D0%B0%D0%BD%D0%B6%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F%20%D0%BA%D0%B0%D1%80%D1%82%D0%BE%D1%87%D0%B5%D0%BA%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D0%B0,%D0%BA%D0%BE%D0%BD%D0%BA%D1%80%D0%B5%D1%82%D0%BD%D0%BE%D0%B3%D0%BE%20%D0%BF%D0%BE%D0%BA%D1%83%D0%BF%D0%B0%D1%82%D0%B5%D0%BB%D1%8F%2C%20%D0%BE%D1%81%D0%BD%D0%BE%D0%B2%D1%8B%D0%B2%D0%B0%D1%8F%D1%81%D1%8C%20%D0%BD%D0%B0%20%D1%82%D0%BE%D0%BC)). Также могут влиять агрегированные признаки: пол (женщине при прочих равных чуть выше покажут женские модели товара) ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=Image%3A%20%E2%9C%85%20%D0%9A%D0%B0%D0%BA%D0%B8%D0%B5%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D1%8B%20%D0%BF%D1%80%D0%B8%D0%BE%D0%B1%D1%80%D0%B5%D1%82%D0%B0%D0%BB)), география (в холодном регионе выше ранжируются теплые вещи – хотя это и под общую популярность попадает, но персональный профиль тоже знает регион).
3. **Персонализация витрины и рекомендаций:** помимо поисковой выдачи и каталога, персонализация проявляется на главной странице и в специальных подборках. Например, раздел «Рекомендуемое для вас» на главной странице формируется полностью на основе предпочтений – это аналог ленты рекомендаций, обсужденной ранее ([Как работает система рекомендаций на Wildberries? - Библиотека Нейро](https://ya.ru/neurum/c/drugoe/q/kak_rabotaet_sistema_rekomendaciy_na_wildberries_60701f71#:~:text=%D0%95%D1%89%D1%91%20%D0%BE%D0%B4%D0%B8%D0%BD%20%D0%B2%D0%B8%D0%B4%20%D1%80%D0%B5%D0%BA%D0%BE%D0%BC%D0%B5%D0%BD%D0%B4%D0%B0%D1%86%D0%B8%D0%B9%20%E2%80%94,2)). В каталоге же (например, открыл пользователь раздел «Телефоны») – могут подмешиваться персональные рекомендации внутри обычного списка. Wildberries могла реализовать это как гибрид: часть товаров – общие хиты категории, а часть – специфические товары, интересные этому пользователю (например, редкий бренд, которым он интересовался раньше, но не очень популярный глобально). Таким образом, каждый пользователь видит слегка разную подборку. В новости от 2023 года отмечалось, что Wildberries внедряет **персонализированную выдачу в поиске**, основанную на предпочтениях конкретного покупателя (его прошлых запросах, посещенных карточках, покупках) ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D1%8C%20%D1%81%D0%B5%D0%B3%D0%BE%D0%B4%D0%BD%D1%8F%D1%88%D0%BD%D0%B5%D0%B3%D0%BE%20%D0%B4%D0%BD%D1%8F%3A%20%D0%B7%D0%B0%D0%BC%D0%B5%D1%87%D0%B5%D0%BD%D1%8B%20%D0%BF%D0%B5%D1%80%D0%B2%D1%8B%D0%B5,%D0%BF%D0%B5%D1%80%D1%81%D0%BE%D0%BD%D0%B0%D0%BB%D0%B8%D0%B7%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%BD%D0%BE%D0%B9%20%D0%B2%D1%8B%D0%B4%D0%B0%D1%87%D0%B8%20%D0%B2%20%D0%B0%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC%D0%B0%D1%85%20Wildberries)). Можно предположить, что и каталожная сортировка “по популярности” становится персонализированной – фактически, *«популярность для данного пользователя»*.
4. **Ограничения и проверка баланса:** Персонализация не должна ухудшать опыт для нового пользователя (о котором ничего не известно) или загонять человека в информационный пузырь только его прошлых интересов. Поэтому алгоритмы содержат «бэк-офф»: часть выдачи остается неперсонализированной или слабо персонализированной, особенно если уверенности мало. Например, первые 2-3 позиции могут быть общими хиты (для всех), а начиная с 4-й – уже персональный микс. Или наоборот, первые позиции – персональные, а дальше – общие, это можно тестировать. Wildberries, вероятно, проводит A/B эксперименты, чтобы найти баланс. Задача аналитиков – **не перегнуть палку**: нужно, чтобы каждая аудитория была довольна, и новому пользователю тоже что-то показывалось осмысленное ([В каких командах и проектах Wildberries есть задачи для аналитиков / Хабр](https://habr.com/ru/companies/wildberries/articles/886064/#:~:text=%D0%A2%D0%B0%D0%BA%D0%B6%D0%B5%20%D0%BE%D0%B4%D0%BD%D0%BE%D0%B9%20%D0%B8%D0%B7%20%D0%B2%D0%B0%D0%B6%D0%BD%D1%8B%D1%85%20%D1%84%D0%B8%D1%87%D0%B5%D0%B9,%D1%81%D0%B2%D0%BE%D0%B8%D0%BC%20%D0%BE%D0%BF%D1%8B%D1%82%D0%BE%D0%BC%20%D0%B2%D0%B7%D0%B0%D0%B8%D0%BC%D0%BE%D0%B4%D0%B5%D0%B9%D1%81%D1%82%D0%B2%D0%B8%D1%8F%20%D1%81%20%D0%BF%D0%BB%D0%B0%D1%82%D1%84%D0%BE%D1%80%D0%BC%D0%BE%D0%B9)). Кроме того, компания учитывает, что персонализация затрудняет продавцам отслеживание своих позиций (порядок товаров становится разным у разных людей) ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%92%D1%82%D0%BE%D1%80%D0%B0%D1%8F%20%D0%BF%D1%80%D0%B8%D1%87%D0%B8%D0%BD%D0%B0%20,%D1%81%D0%B5%D0%B9%D1%87%D0%B0%D1%81%20%D0%BD%D0%B5%20%D0%B7%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D0%BD%D0%B8%D1%82%D1%8C%D1%81%D1%8F%20%D0%B2%20%D0%9B%D0%9A)). Поэтому, возможно, полная персонализация вводится постепенно и не на всех страницах (например, может затрагивать только некоторую часть сортировки “по популярности”, а явные сортировки “по цене” или “по отзывам” остаются одинаковыми для всех).
...
- *Метрики продавцов.* Wildberries также учитывает фидбек от продавцов: если персонализация слишком бьет по видимости каких-то товаров, это может быть проблемой. В новости отмечалось, что внешние аналитические сервисы перестанут правильно показывать позиции товаров, и Wildberries может монетизировать доступ к “настоящей” (персонализированной) выдаче ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%92%D1%82%D0%BE%D1%80%D0%B0%D1%8F%20%D0%BF%D1%80%D0%B8%D1%87%D0%B8%D0%BD%D0%B0%20,%D1%81%D0%B5%D0%B9%D1%87%D0%B0%D1%81%20%D0%BD%D0%B5%20%D0%B7%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D0%BD%D0%B8%D1%82%D1%8C%D1%81%D1%8F%20%D0%B2%20%D0%9B%D0%9A)). То есть контроль за метриками прозрачности тоже имеет место.

**Пример персонализации.** *Два пользователя заходят на Wildberries и открывают раздел «Спортивные кроссовки»:* один – профессиональный бегун, часто покупал товары для бега; второй – школьник, интересуется кэжуал-кроссовками популярных брендов. Без персонализации они бы увидели одинаковый список топ-продаж (например, кроссовки Nike, Adidas, Puma в перемешку). С персонализацией первый пользователь-бегун увидит выше кроссовки для бега (с хорошей амортизацией, возможно менее модные, но более функциональные), а второй – модные модели, которые носят подростки, яркие расцветки, limited edition, т.к. система знает его возраст и предыдущие клики на модные кеды. Оба пользователя находят то, что им ближе, без лишней прокрутки. Другой пример: в поиске по запросу “ремень” пользователь-женщина увидит в топе преимущественно женские ремни, а мужчина – мужские, хотя запрос нейтральный. Это и есть персонализация по полу и интересам, увеличивающая шанс покупки с поиска ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%AD%D1%82%D0%BE%20%D0%BF%D0%BE%D1%81%D1%82%D1%80%D0%BE%D0%B5%D0%BD%D0%B8%D0%B5%20%D1%80%D0%B0%D0%BD%D0%B6%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F%20%D0%BA%D0%B0%D1%80%D1%82%D0%BE%D1%87%D0%B5%D0%BA%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D0%B0,%D0%BA%D0%BE%D0%BD%D0%BA%D1%80%D0%B5%D1%82%D0%BD%D0%BE%D0%B3%D0%BE%20%D0%BF%D0%BE%D0%BA%D1%83%D0%BF%D0%B0%D1%82%D0%B5%D0%BB%D1%8F%2C%20%D0%BE%D1%81%D0%BD%D0%BE%D0%B2%D1%8B%D0%B2%D0%B0%D1%8F%D1%81%D1%8C%20%D0%BD%D0%B0%20%D1%82%D0%BE%D0%BC)) ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=Image%3A%20%E2%9C%85%20%D0%9A%D0%B0%D0%BA%D0%B8%D0%B5%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D1%8B%20%D0%BF%D1%80%D0%B8%D0%BE%D0%B1%D1%80%D0%B5%D1%82%D0%B0%D0%BB)).

**Обоснование подхода.** Персонализация выдачи – логичный шаг эволюции маркетплейса. В условиях, когда ассортимент огромен, пользователи ценят, когда платформа «подстраивается» под них. Компании вроде Amazon, AliExpress давно применяют персонализированные главные страницы и подборки. Wildberries, анализируя данные, пришел к тому, что это увеличит продажи: *«чем более релевантные товары он будет выдавать в поиске, тем больше и быстрее будут происходить продажи»* ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=Wildberries%20%D0%B7%D0%B0%D1%82%D0%BE%D1%87%D0%B5%D0%BD%20%D0%BD%D0%B0%20%D0%BF%D1%80%D0%BE%D0%B4%D0%B0%D0%B6%D0%B8%2C%20%D1%87%D0%B5%D0%BC,%D0%B8%20%D0%B1%D1%8B%D1%81%D1%82%D1%80%D0%B5%D0%B5%20%D0%BF%D1%80%D0%BE%D0%B4%D0%B0%D0%B6%D0%B8%20%D0%B1%D1%83%D0%B4%D1%83%D1%82%20%D0%BF%D1%80%D0%BE%D0%B8%D1%81%D1%85%D0%BE%D0%B4%D0%B8%D1%82%D1%8C)). Внедрение персонализации также стратегически выгодно Wildberries, чтобы **ограничить работу сторонних сервисов аналитики**, показывающих продавцам их позиции ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%92%D1%82%D0%BE%D1%80%D0%B0%D1%8F%20%D0%BF%D1%80%D0%B8%D1%87%D0%B8%D0%BD%D0%B0%20,%D1%81%D0%B5%D0%B9%D1%87%D0%B0%D1%81%20%D0%BD%D0%B5%20%D0%B7%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D0%BD%D0%B8%D1%82%D1%8C%D1%81%D1%8F%20%D0%B2%20%D0%9B%D0%9A)). Если у каждого свой рейтинг, то “общей” картинки нет – тем самым Wildberries получает контроль над данными и может предлагать продавцам платные инсайты о персонализированной выдаче ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D1%81%D1%82%D0%BE%D1%80%D0%BE%D0%BD%D0%BD%D0%B8%D0%B5%20%D0%B0%D0%BD%D0%B0%D0%BB%D0%B8%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B5%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D1%8B%20%D1%81%D0%BC%D0%BE%D0%B3%D1%83%D1%82%20%D0%BF%D0%BE%D0%BA%D0%B0%D0%B7%D1%8B%D0%B2%D0%B0%D1%82%D1%8C,%D1%81%D0%B5%D0%B9%D1%87%D0%B0%D1%81%20%D0%BD%D0%B5%20%D0%B7%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D0%BD%D0%B8%D1%82%D1%8C%D1%81%D1%8F%20%D0%B2%20%D0%9B%D0%9A)). С технической стороны, персонализация – сложный алгоритмический надстрой над поиском/каталогом. Wildberries уже имеет системы рекомендаций и сбора пользовательских данных, поэтому использовать их для сортировки каталога – обоснованный шаг. Подход включает использование алгоритмов машинного обучения (например, факторизация матрицы «пользователь-товар» для предсказания рейтинга интереса) и сегментных правил. Выбран он потому, что показал эффективность в эксперименте: как только в 2023 году начали тестировать персональную выдачу, результаты доказали ее работоспособность, и появились «первые следы» этой технологии на боевом сайте ([Персонализированная выдача в поиске на Wildberries уже реальность? — Дмитрий Чебан на TenChat.ru](https://tenchat.ru/media/1971769-personalizirovannaya-vydacha-v-poiske-na-wildberries-uzhe-realnost#:~:text=%D0%9D%D0%BE%D0%B2%D0%BE%D1%81%D1%82%D1%8C%20%D1%81%D0%B5%D0%B3%D0%BE%D0%B4%D0%BD%D1%8F%D1%88%D0%BD%D0%B5%D0%B3%D0%BE%20%D0%B4%D0%BD%D1%8F%3A%20%D0%B7%D0%B0%D0%BC%D0%B5%D1%87%D0%B5%D0%BD%D1%8B%20%D0%BF%D0%B5%D1%80%D0%B2%D1%8B%D0%B5,%D0%BF%D0%B5%D1%80%D1%81%D0%BE%D0%BD%D0%B0%D0%BB%D0%B8%D0%B7%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%BD%D0%BE%D0%B9%20%D0%B2%D1%8B%D0%B4%D0%B0%D1%87%D0%B8%20%D0%B2%20%D0%B0%D0%BB%D0%B3%D0%BE%D1%80%D0%B8%D1%82%D0%BC%D0%B0%D1%85%20Wildberries)). Персонализация дополняет общий алгоритм ранжирования, делая Wildberries более ориентированным на каждого конкретного клиента – а это в конечном счете повышает удовлетворенность и lifetime value клиентов.


## 8. **Технология** | **Область применения** | **Мотивация**
---|---|---
**Golang** | Основной язык серверного **backend**-разработки (микросервисы Wildberries). Используется для высоконагруженных веб-сервисов и API. | Высокая производительность и эффективная параллелизм (goroutines), минимальное потребление памяти, компиляция в самостоятельный бинарник. Активное сообщество и богатая экосистема для микросервисов.
**Rust** | Язык программирования для отдельных высокопроизводительных сервисов и системных утилит в инфраструктуре WB ([WBTECH](https://wbtech.wildberries.ru/#:~:text=Rust%2C)). Применяется там, где критична скорость и безопасность памяти. | Гарантия отсутствия утечек памяти и гонок данных благодаря строгой модели памяти, высокая производительность на уровне C++, удобен для разработки системных компонентов. Перспективный язык с растущим сообществом ([WBTECH](https://wbtech.wildberries.ru/#:~:text=Rust%2C)).
**React (TypeScript)** | **Frontend**: Фреймворк (библиотека) для создания динамичных веб-интерфейсов маркетплейса и внутренних кабинетов. Основной выбор для пользовательских веб-приложений Wildberries ([WBTECH](https://wbtech.wildberries.ru/#:~:text=K8s%2C)). | Компонентный подход и Virtual DOM обеспечивают высокую скорость UI, богатая экосистема библиотек. Использование TypeScript повышает надежность за счёт типизации, что упрощает поддержку большого фронтенда.
**Angular (TypeScript)** | **Frontend**: Фреймворк для веб-приложений (например, админ-панели или портал продавцов). Используется для масштабных приложений с сложной логикой на стороне клиента ([WBTECH](https://wbtech.wildberries.ru/#:~:text=Rust%2C)). | Структурированная архитектура (MVC/DI) упрощает поддержку большого кода, двухстороннее связывание данных ускоряет разработку форм. TypeScript изначально поддерживается, что повышает качество кода. Долгосрочная поддержка Google и сообщество.
**Vue.js** | **Frontend**: Фреймворк, применяемый в отдельных веб-модулях или проектах Wildberries (вакансии упоминают возможность разработки на Vue) ([Frontend-разработчик | Wildberries - LinkedIn](https://ru.linkedin.com/pulse/frontend-%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%87%D0%B8%D0%BA-wildberries-nina-voronkova#:~:text=Frontend,%D0%9C%D1%8B%20%D0%BF%D1%80%D0%B5%D0%B4%D0%BB%D0%B0%D0%B3%D0%B0%D0%B5%D0%BC%3A%20%D0%A1%D0%BB%D0%BE%D0%B6%D0%BD%D1%8B%D0%B5%20%D0%B8)). | Низкий порог входа и гибкость интеграции в существующий проект. Реактивный двунаправленный биндинг и лёгкость создают быструю разработку UI. Активное сообщество и богатый набор плагинов.
**PostgreSQL** | Реляционная **база данных** для хранения критически важных данных (заказы, аккаунты, каталоги и пр.) ([Вакансия Senior Golang Developer (Автоматизация с применением ИИ), в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119115567#:~:text=%D0%A1%D1%82%D0%B5%D0%BA%3A%20Go%2C%20Postgres%2C%20Clickhouse%2C%20Kafka%2C,Nats%2C%20Redis)). Используется микросервисами для транзакционных операций и консистентного хранения данных. | Надёжность и полноценная поддержка ACID-транзакций. Горизонтальное масштабирование через шардирование и репликацию для чтения. Open-source без лицензионных платежей (в отличие от MS SQL) ([Вызовы цифровой трансформации, с которыми справляется Tarantool](https://www.tarantool.io/blog/ru/digitaltransformation/#:~:text=%D0%97%D0%B0%D0%B4%D0%B0%D1%87%D0%B0,%D1%86%D0%B5%D0%BD%D1%82%D1%80%D0%B0%20%D0%BD%D0%B0%20%D0%B4%D1%80%D1%83%D0%B3%D0%BE%D0%B9%3B%20%D0%B3%D0%BE%D1%80%D0%B8%D0%B7%D0%BE%D0%BD%D1%82%D0%B0%D0%BB%D1%8C%D0%BD%D0%BE%D0%B5%20%D0%BC%D0%B0%D1%81%D1%88%D1%82%D0%B0%D0%B1%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5)), широкое сообщество и инструментарий.
**Tarantool** | Высокопроизводительное **in-memory** хранилище (NoSQL) и сервер приложений. Применяется для кеширования и быстрого доступа к наиболее востребованным данным – профили пользователей, избранные/отложенные товары, скидки и др. ([Вызовы цифровой трансформации, с которыми справляется Tarantool](https://www.tarantool.io/blog/ru/digitaltransformation/#:~:text=%D0%A0%D0%B5%D1%88%D0%B5%D0%BD%D0%B8%D0%B5,%D0%BD%D0%B0%20Tarantool%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0%D1%8E%D1%82%2012%20%D0%BC%D0%B8%D0%BA%D1%80%D0%BE%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)). В Wildberries на Tarantool реализовано ~12 микросервисов, включая мастер-хранилище профилей (данные 50 млн пользователей) и сервис «отложенных товаров» (~120 ГБ в памяти на инстанс) ([Вызовы цифровой трансформации, с которыми справляется Tarantool](https://www.tarantool.io/blog/ru/digitaltransformation/#:~:text=%D0%A0%D0%B5%D0%B7%D1%83%D0%BB%D1%8C%D1%82%D0%B0%D1%82,%D1%81%D0%BE%D0%B4%D0%B5%D1%80%D0%B6%D0%B8%D1%82%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5%2050%20%D0%BC%D0%B8%D0%BB%D0%BB%D0%B8%D0%BE%D0%BD%D0%BE%D0%B2%20%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D0%BE%D0%B2%D0%B0%D1%82%D0%B5%D0%BB%D0%B5%D0%B9)). | Очень высокая скорость работы в памяти при наличии персистентности на диск. Автоматическая репликация и **failover** между дата-центрами, горизонтальное масштабирование под рост данных ([Вызовы цифровой трансформации, с которыми справляется Tarantool](https://www.tarantool.io/blog/ru/digitaltransformation/#:~:text=%D0%97%D0%B0%D0%B4%D0%B0%D1%87%D0%B0,%D1%86%D0%B5%D0%BD%D1%82%D1%80%D0%B0%20%D0%BD%D0%B0%20%D0%B4%D1%80%D1%83%D0%B3%D0%BE%D0%B9%3B%20%D0%B3%D0%BE%D1%80%D0%B8%D0%B7%D0%BE%D0%BD%D1%82%D0%B0%D0%BB%D1%8C%D0%BD%D0%BE%D0%B5%20%D0%BC%D0%B0%D1%81%D1%88%D1%82%D0%B0%D0%B1%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5)). Экономия ресурсов по сравнению с монолитной СУБД (замена дорогого MS SQL) ([Вызовы цифровой трансформации, с которыми справляется Tarantool](https://www.tarantool.io/blog/ru/digitaltransformation/#:~:text=%D0%97%D0%B0%D0%B4%D0%B0%D1%87%D0%B0,%D1%86%D0%B5%D0%BD%D1%82%D1%80%D0%B0%20%D0%BD%D0%B0%20%D0%B4%D1%80%D1%83%D0%B3%D0%BE%D0%B9%3B%20%D0%B3%D0%BE%D1%80%D0%B8%D0%B7%D0%BE%D0%BD%D1%82%D0%B0%D0%BB%D1%8C%D0%BD%D0%BE%D0%B5%20%D0%BC%D0%B0%D1%81%D1%88%D1%82%D0%B0%D0%B1%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5)). Активная поддержка (разработчик – VK) и встроенные возможности Lua-скриптов для логики.
**Redis** | Быстродоступное **in-memory** хранилище ключ-значение. Используется как кеш для веб-сервисов (сессии, временные данные, актуальные счетчики) и механизмы публикации/подписки в реальном времени. | Мгновенные операции чтения/записи из памяти, поддержка структур данных (списки, хэши, и пр.) для гибкого кеширования. Простой в использовании, минимальная задержка – идеально для высоконагруженных сценариев. Широко применяется в индустрии, большой набор готовых инструментов.
**ClickHouse** | Колонковая **аналитическая СУБД** для обработки больших объёмов данных. Применяется для хранения и аналитики логов, бизнес-метрик, отчётности и ML-данных (OLAP-нагрузки) ([Вакансия Senior Golang Developer (Автоматизация с применением ИИ), в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119115567#:~:text=%D0%A1%D1%82%D0%B5%D0%BA%3A%20Go%2C%20Postgres%2C%20Clickhouse%2C%20Kafka%2C,Nats%2C%20Redis)). | Экстремально высокая скорость агрегаций и сложных SQL-запросов по большим таблицам за счёт колонночного хранения и сжатия данных. Масштабируется горизонтально на кластере серверов. Open-source решение, оптимизированное под аналитические запросы (разработано в Яндексе), что снижает затраты на лицензии по сравнению с проприетарными СУБД.
**Vertica** | Enterprise-аналитическая СУБД (колонночная). Используется в отдельных задачах аналитики данных и BI-отчетности (возможно, исторически до/наряду с ClickHouse) ([WBTECH](https://wbtech.wildberries.ru/#:~:text=Python%2C)). | Высокая производительность на сложных запросах по большим наборам данных, надежность уровня enterprise. Имеет развитые средства для аналитики и параллельные вычисления. Мотивация использования – существовавшая инфраструктура и инструменты, требующие Vertica, и потребность в проверенном решении для аналитики до появления альтернатив.
**Elasticsearch / OpenSearch** | **Поисковый движок** для полнотекстового поиска по каталогу товаров, отзывам и другим текстовым данным. Обеспечивает быстрый поиск и фильтрацию на сайте. Также задействуется для хранения и поиска логов (стек ELK, в виде форка OpenSearch) ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=,%D0%BD%D0%B0%D0%B4%D0%B5%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D0%B8%20%D0%BF%D1%80%D0%BE%D0%B7%D1%80%D0%B0%D1%87%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)). Кроме того, для поиска по изображениям Wildberries внедрили векторное хранилище и нейросети (поиск по эмбеддингам) ([Wildberries перезапустила функцию поиска товаров по фото на сайте и в приложении / Хабр](https://habr.com/ru/news/847622/#:~:text=%D0%9D%D0%BE%D0%B2%D0%B0%D1%8F%20%D0%B0%D1%80%D1%85%D0%B8%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%B0%20%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%B0%2C%20%D0%B8%D1%81%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D1%83%D1%8E%D1%89%D0%B0%D1%8F%20%D0%BA%D0%BE%D0%BC%D0%B1%D0%B8%D0%BD%D0%B0%D1%86%D0%B8%D1%8E,%D0%B0%D0%BA%D1%82%D1%83%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5%20%D1%86%D0%B5%D0%BD%D1%8B%20%D0%B8%20%D0%B0%D0%BD%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D1%87%D0%BD%D1%8B%D0%B5%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D1%8B)). | Мощный полнотекстовый поиск с поддержкой сложного ранжирования и агрегаций. Горизонтально масштабируется на кластер узлов, выдерживая большой индекс данных. Имеет богатый набор функций (фасетный поиск, подсветка, синаонимы) и большое сообщество. OpenSearch как открытую альтернативу используют для логирования (избежание лицензий Elastic). Новые методы векторного поиска повышают релевантность результатов для мультимедийного поиска ([Wildberries перезапустила функцию поиска товаров по фото на сайте и в приложении / Хабр](https://habr.com/ru/news/847622/#:~:text=%D0%9D%D0%BE%D0%B2%D0%B0%D1%8F%20%D0%B0%D1%80%D1%85%D0%B8%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%B0%20%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%B0%2C%20%D0%B8%D1%81%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D1%83%D1%8E%D1%89%D0%B0%D1%8F%20%D0%BA%D0%BE%D0%BC%D0%B1%D0%B8%D0%BD%D0%B0%D1%86%D0%B8%D1%8E,%D0%B0%D0%BA%D1%82%D1%83%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5%20%D1%86%D0%B5%D0%BD%D1%8B%20%D0%B8%20%D0%B0%D0%BD%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D1%87%D0%BD%D1%8B%D0%B5%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D1%8B)).
**Apache Kafka** | **Брокер сообщений** и платформа стриминга данных. В Wildberries служит для асинхронной передачи событий между сервисами (например, события заказов, уведомления) и организации потоков данных в реальные системы и хранилища ([Вакансия Senior Golang Developer (Автоматизация с применением ИИ), в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119115567#:~:text=%D0%A1%D1%82%D0%B5%D0%BA%3A%20Go%2C%20Postgres%2C%20Clickhouse%2C%20Kafka%2C,Nats%2C%20Redis)). Также используется для сбора и доставки логов и аналитических данных (интеграция с ClickHouse и др.). | Обеспечивает высокую пропускную способность и отказоустойчивое хранение сообщений (диск + репликация). Позволяет интегрировать микро-сервисы с минимальной связанностью (event-driven architecture). Хорошо масштабируется горизонтально под рост нагрузки, де-факто стандарт для стриминга больших данных.
**NATS** | Легковесный **message-broker** для обмена сообщениями между сервисами в режиме real-time. Применяется для внутренних коммуникаций микросервисов, требующих минимальной задержки (например, быстрого распространения событий, RPC вызовов) ([Вакансия Senior Golang Developer (Автоматизация с применением ИИ), в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119115567#:~:text=%D0%A1%D1%82%D0%B5%D0%BA%3A%20Go%2C%20Postgres%2C%20Clickhouse%2C%20Kafka%2C,Nats%2C%20Redis)). | Очень низкие задержки доставки сообщений, простая модель pub/sub без сложной конфигурации. Минимальное потребление ресурсов, подходит для быстрого обмена уведомлениями. Горизонтально масштабируется кластеризацией. Отсутствие перегрузки функционалом (в отличие от тяжелых брокеров) упрощает поддержку.
**Nginx** | **Веб-сервер и обратный прокси**. На фронте Wildberries работает как балансировщик нагрузки HTTP(S) трафика и сервер статического контента (кеширование изображений, страниц) ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=%D0%B8%20%D1%81%D0%B2%D1%8F%D0%B7%D0%B0%D0%BD%D0%BD%D1%8B%D1%85%20%D1%81%20%D0%BD%D0%B5%D0%B9%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)). Также используется как gateway/proxy для маршрутизации запросов к микросервисам. | Известен высокой производительностью и малым потреблением памяти благодаря событийной архитектуре. Способен обрабатывать тысячи одновременных соединений, что критично для нагрузки маркетплейса. Гибкость настройки (Lua-скрипты, модули) и широкая поддержка делают его индустриальным стандартом веб-серверов.
**HAProxy** | Программный **балансировщик нагрузки** на уровне TCP/HTTP, дополняющий Nginx. Задействован для распределения трафика между сервисами и обеспечения отказоустойчивости в сети (например, балансировка внутренних API, SMTP/SMTP-шлюзы и т.п.) ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=%D0%B8%20%D1%81%D0%B2%D1%8F%D0%B7%D0%B0%D0%BD%D0%BD%D1%8B%D1%85%20%D1%81%20%D0%BD%D0%B5%D0%B9%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)). | Специализирован на высокой скорости проксирования TCP/HTTP с минимальными накладными расходами. Поддерживает проверки здоровья (health checks) и продвинутые алгоритмы балансировки. Легковесен и надёжен, широко применяется в highload-системах для равномерного распределения нагрузки.
**Kubernetes** | Платформа оркестрации контейнеров. В Wildberries развёртывает и управляет сотнями микросервисов в кластерах, автоматизирует масштабирование, перезапуск и размещение контейнеров на серверах. Есть собственные инструменты для деплоя Kubernetes-кластеров (“deadbeat”) ([Как работает крупнейший маркетплейс: что у него под капотом / Хабр](https://habr.com/ru/articles/598961/#:~:text=%D0%BF%D1%83%D1%82%D1%8C%20%D0%BD%D0%B0%D0%BB%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F%20%D0%BA%D0%BB%D0%B0%D1%81%D1%82%D0%B5%D1%80%D0%B0%20%D0%BF%D0%BE%D0%B4%20%D0%BA%D0%B0%D0%B6%D0%B4%D1%8B%D0%B9,%D0%B4%D0%BB%D1%8F%20%D0%B4%D0%B5%D0%BF%D0%BB%D0%BE%D1%8F%20K8S%20%E2%80%94%20deadbeat)). | Обеспечивает отказоустойчивость приложений: при падении пода запускается новый, при росте нагрузки легко добавить инстансы ([Как работает крупнейший маркетплейс: что у него под капотом / Хабр](https://habr.com/ru/articles/598961/#:~:text=,%D0%B4%D0%BE%D0%BB%D0%B6%D0%BD%D0%BE%20%D0%BB%D0%B5%D0%B3%D0%BA%D0%BE%20%D0%BC%D0%B0%D1%81%D1%88%D1%82%D0%B0%D0%B1%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D1%82%D1%8C%D1%81%D1%8F%20%D0%B4%D0%BE%D0%B1%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%D0%BC%20%D0%B8%D0%BD%D1%81%D1%82%D0%B0%D0%BD%D1%81%D0%BE%D0%B2)) ([Как работает крупнейший маркетплейс: что у него под капотом / Хабр](https://habr.com/ru/articles/598961/#:~:text=,%D1%81%D0%B2%D0%BE%D1%8E%20%D1%80%D0%B5%D0%B0%D0%BB%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8E%20%D0%BF%D0%BE%D0%B4%20%D0%BA%D0%BE%D0%BD%D0%BA%D1%80%D0%B5%D1%82%D0%BD%D1%83%D1%8E%20%D0%B7%D0%B0%D0%B4%D0%B0%D1%87%D1%83)). Стандартизует управление инфраструктурой (declerative config, операторы), облегчая сопровождение большого числа сервисов. Поддержка со стороны Cloud Native сообщества и переносимость между облаком и железом.
**Docker** | Система контейнеризации, используемая для упаковки приложений. Весь backend Wildberries упакован в Docker-образы, что обеспечивает единообразие среды от разработки до продакшена ([Вакансия Senior Golang Developer (Автоматизация с применением ИИ), в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119115567#:~:text=,%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B%20%D1%81%20Docker%20%D0%B8%20Kubernetes)). | Изоляция приложений и их зависимостей в контейнере гарантирует предсказуемость запуска. Упрощает деплой – образ содержит всё необходимое. Легко масштабировать запуском множества контейнеров. Широко поддерживается (де-факто стандарт), интегрируется с CI/CD конвейерами и Kubernetes.
**GitLab CI/CD** | Платформа для непрерывной интеграции и доставки. Применяется для автоматизации сборки, тестирования и деплоя сервисов Wildberries ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=,%D1%83%D0%BF%D1%80%D0%BE%D1%89%D0%B5%D0%BD%D0%B8%D1%8F%20%D0%B8%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%D0%B8%20%D0%B4%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%BA%D0%B8%20%D0%BA%D0%BE%D0%B4%D0%B0)). Все проекты интегрированы с конвейерами GitLab CI – от запуска автотестов до выкладки в Kubernetes. | Ускоряет выпуск новых функций (сокращает **time-to-market**): изменения проходят автоматический цикл тестирования и попадают в продакшн без ручного вмешательства. Обеспечивает единообразие процессов сборки/деплоя, что снижает человеческий фактор. Глубокая интеграция с репозиторием кода (GitLab) и поддержка масштабирования агентов.
**Prometheus** | Система мониторинга и сбора метрик. В Wildberries собирает метрики со всех микросервисов и инфраструктуры (нагрузка CPU/RAM, время отклика, бизнес-метрики) ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=,%D0%BD%D0%B0%D0%B4%D0%B5%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D0%B8%20%D0%BF%D1%80%D0%BE%D0%B7%D1%80%D0%B0%D1%87%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)). Настроены правила алертинга при отклонении метрик. Используется совместно с Thanos/VictoriaMetrics для масштабирования хранения. | Open-source решение, созданное для динамичных облачных сред: легко интегрируется с Kubernetes (Service Discovery подов). Эффективное хранение метрик в виде временных рядов, язык запросов PromQL для гибкого анализа. Можно горизонтально масштабировать (через федерацию или Thanos) под рост системы. Большое сообщество, множество готовых экспортеров метрик для любых сервисов.
**Grafana** | Платформа визуализации мониторинга. Используется для построения дашбордов и графиков на основе метрик Prometheus и логов (ELK) ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=,%D0%BD%D0%B0%D0%B4%D0%B5%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D0%B8%20%D0%BF%D1%80%D0%BE%D0%B7%D1%80%D0%B0%D1%87%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)). Инженеры Wildberries в реальном времени отслеживают состояние сервисов через Grafana (например, ошибки, RPS, задержки) и заводят алерты. | Удобный веб-интерфейс для создания наглядных панелей и уведомлений. Поддерживает множество источников данных (Prometheus, Elasticsearch/OpenSearch, etc.), что позволяет в едином окне видеть метрики и логи. Активно развивается сообществом. Повышает оперативность реагирования на инциденты благодаря наглядности.
**OpenSearch (ELK)** | **Логирование** и анализ логов. Стек на базе Elasticsearch/OpenSearch используется для централизованного сбора логов со всех сервисов Wildberries ([Вакансия Senior DevOps Engineer [Sender], в компании WILDBERRIES](https://dreamjob.ru/employers/6690/vakansii/119339877#:~:text=,%D0%BD%D0%B0%D0%B4%D0%B5%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D0%B8%20%D0%BF%D1%80%D0%BE%D0%B7%D1%80%D0%B0%D1%87%D0%BD%D0%BE%D1%81%D1%82%D0%B8%20%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%8B%20%D1%81%D0%B5%D1%80%D0%B2%D0%B8%D1%81%D0%BE%D0%B2)) (с последующей визуализацией в Kibana/Grafana). Позволяет инженерам быстро искать по логам ошибок и строить аналитические отчёты. | Централизованное хранилище логов упрощает отладку распределённых систем. Полнотекстовый поиск по логам (включая фильтры по полям) помогает быстрее находить нужные события. OpenSearch – открытый форк Elasticsearch – избегает проблем с лицензированием, сохраняя мощный функционал поиска. Масштабируется на кластер узлов под растущий объём логов, обеспечивает устойчивость за счёт репликации данных.
**Apache Hadoop & Spark** | Платформа **Big Data** для пакетной обработki данных. В Wildberries используется для офлайн-аналитики: массовая обработка сырых логов, построение витрин данных, расчет рекомендаций и отчётов офлайн ([WBTECH](https://wbtech.wildberries.ru/#:~:text=Hadoop%2C)). HDFS (Hadoop) хранит большие данные, Spark распределенно обрабатывает их (map/reduce, MLlib и пр). | Предназначены для работы с очень большими объёмами данных, превышающими возможности отдельных серверов. Горизонтально масштабируются на кластере машин, обеспечивая высокую пропускную способность при обработке. Богатая экосистема (Hive, HDFS, Spark SQL) позволяет писать сложные аналитические задачи. Стандарт де-факто для batch-аналитики в промышленности.
**TensorFlow & PyTorch** | Фреймворки **machine learning** и глубокого обучения. В Wildberries применяются для разработки моделей рекомендаций, ранжирования поиска и компьютерного зрения (например, распознавание товаров по фото) ([WBTECH](https://wbtech.wildberries.ru/#:~:text=PyTorch%2C)) ([Wildberries перезапустила функцию поиска товаров по фото на сайте и в приложении / Хабр](https://habr.com/ru/news/847622/#:~:text=%D0%9D%D0%BE%D0%B2%D0%B0%D1%8F%20%D0%B0%D1%80%D1%85%D0%B8%D1%82%D0%B5%D0%BA%D1%82%D1%83%D1%80%D0%B0%20%D0%BF%D0%BE%D0%B8%D1%81%D0%BA%D0%B0%2C%20%D0%B8%D1%81%D0%BF%D0%BE%D0%BB%D1%8C%D0%B7%D1%83%D1%8E%D1%89%D0%B0%D1%8F%20%D0%BA%D0%BE%D0%BC%D0%B1%D0%B8%D0%BD%D0%B0%D1%86%D0%B8%D1%8E,%D0%B0%D0%BA%D1%82%D1%83%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5%20%D1%86%D0%B5%D0%BD%D1%8B%20%D0%B8%20%D0%B0%D0%BD%D0%B0%D0%BB%D0%BE%D0%B3%D0%B8%D1%87%D0%BD%D1%8B%D0%B5%20%D1%82%D0%BE%D0%B2%D0%B0%D1%80%D1%8B)). Модели обучаются на больших данных о пользователях и товарах, повышая качество рекомендаций и поиска. | Позволяют строить нейросети любой сложности и эффективно обучать их на GPU. TensorFlow – от Google (удобен для промышленных ML-систем), PyTorch – от Facebook (гибок в исследованиях), оба имеют огромное сообщество. Использование этих фреймворков обеспечивает высокую точность моделей и быстрый перенос новейших научных достижений (например, модели из библиотеки HuggingFace) в продукт ([Wildberries перезапустила функцию поиска товаров по фото на сайте и в приложении / Хабр](https://habr.com/ru/news/847622/#:~:text=%D0%B8%D0%B7%D0%BE%D0%B1%D1%80%D0%B0%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F%D1%85%20%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D0%BD%D1%8F%D0%B5%D1%82%D1%81%D1%8F%20%D0%B2%D0%B5%D0%BA%D1%82%D0%BE%D1%80%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F%3A%20%D0%B2%20%D0%B1%D0%B0%D0%B7%D0%B5,%D0%B8%D0%B7%D0%BE%D0%B1%D1%80%D0%B0%D0%B6%D0%B5%D0%BD%D0%B8%D0%B9%20%D0%B8%20950%20%D0%BC%D0%BB%D0%BD%20%D0%BF%D0%B0%D1%80%D0%B0%D0%BC%D0%B5%D1%82%D1%80%D0%BE%D0%B2)).
